          ...
          >
            ...
            <el-form-item label="密码策略">
              <el-checkbox-group v-model="securityForm.passwordPolicy">
                <el-checkbox value="requireUppercase">
                  必须包含大写字母
                </el-checkbox>
                <el-checkbox value="requireLowercase">
                  必须包含小写字母
                </el-checkbox>
                <el-checkbox value="requireNumbers">
                  必须包含数字
                </el-checkbox>
                <el-checkbox value="requireSpecialChars">
                  必须包含特殊字符
                </el-checkbox>
              </el-checkbox-group>
            </el-form-item>
